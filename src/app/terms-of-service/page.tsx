export default function TermsOfService() {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold">Website Terms of Service</h1>
      ...
      <p>By using the Service, you agree to be bound by these Terms and our Privacy Policy. If you do not agree to these Terms, you must not access or use our Service.</p>

      <h2 className="text-xl font-bold mt-4">2. Changes to the Terms</h2>
      ...
      <h2 className="text-xl font-bold mt-4">3. Accessing the Service and Account Security</h2>
      <p>We reserve the right to withdraw or amend our Service, and any service or material we provide on the Service, in our sole discretion without notice. We will not be liable if for any reason all or any part of the Service is unavailable at any time or for any period.</p>

      <p>To access the Service or some of the resources it offers, you may be asked to provide certain registration details or other information. It is a condition of your use of the Service that all the information you provide is correct, current, and complete.</p>

      <h2 className="text-xl font-bold mt-4">4. Intellectual Property Rights</h2>
      <p>The Service and its entire contents, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof) are owned by us, our licensors, or other providers of such material and are protected by United Kingdom and international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.</p>
      ...
      <h2 className="text-xl font-bold mt-4">5. Prohibited Uses</h2>
      ...
      <h2 className="text-xl font-bold mt-4">7. Reliance on Information Posted</h2>
      <p>The information presented on or through the Service is made available solely for general information purposes. We do not warrant the accuracy, completeness, or usefulness of this information. Any reliance you place on such information is strictly at your own risk.</p>

      <h2 className="text-xl font-bold mt-4">8. Links from the Website</h2>
      <p>If the Service contains links to other sites and resources provided by third parties, these links are provided for your convenience only. We have no control over the contents of those sites or resources, and accept no responsibility for them or for any loss or damage that may arise from your use of them.</p>

      <h2 className="text-xl font-bold mt-4">9. Geographic Restrictions</h2>
      ...
      <p>Any legal suit, action, or proceeding arising out of, or related to, these Terms or the Service shall be instituted exclusively in the courts of England and Wales.</p>

      <h2 className="text-xl font-bold mt-4">14. Your Comments and Concerns</h2>
      <p>This website is operated by [Your Website Name].</p>

      <p>All other feedback, comments, requests for technical support, and other communications relating to the Service should be directed to: [Your Contact Email Address].</p>
    </div>
  );
}
